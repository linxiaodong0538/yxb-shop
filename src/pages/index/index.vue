				...
				<view class="row" v-for="(row,index) in msgList" :key="index" :id="'msg'+row.msg.id">
					...
					<block v-if="row.type=='user'">
						...
						<view class="my" v-if="row.msg.userinfo.uid==myuid">
							...
							<view class="left">
								<!-- 文字消息 -->
						<view v-if="true" class="bubble">
								<rich-text nodes="&lt;div style='display: flex;align-items: center;word-wrap:break-word;'&gt;&lt;img src='https://s2.ax1x.com/2019/04/12/AbNljI.gif'&gt;&lt;img src='https://s2.ax1x.com/2019/04/12/AbNljI.gif'&gt;2&lt;/div&gt;"></rich-text>
							</view>
								<!-- 图片消息 -->
								<view v-if="false" class="bubble img" @tap="showPic(row.msg)">
									<image src="../../static/logo.png" style=""></image>
								</view>
							</view>
							<!-- 右-头像 -->
							<view class="right">
						...
						<view class="other" v-if="row.msg.userinfo.uid!=myuid">
							...
							<view class="right">
								<view class="username">
									<view class="name">张三</view> <view class="time">19:05</view>
								</view>
								<!-- 文字消息 -->
								<view v-if="true" class="bubble">
									今天好热
								...
								<!-- 图片消息 -->
								<view v-if="false" class="bubble img" @tap="showPic(row.msg)">
									<image src="../../static/img/p10.jpg" style=""></image>
								</view>
							</view>
						</view>
					</block>
